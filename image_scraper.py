...
def scrape_and_download_images(image_description, image_class): 
    ...
    res = requests.get('https://www.google.com/search?q=' + 'unattended ' + image_description + 'without a person' + '&source=lnms&tbm=isch')
...
scrape_and_download_images('backpacks', 'backpacks')
